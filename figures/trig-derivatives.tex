...
% alt: A unit circle with a radius at angle theta; nudging the angle by
%   delta-theta traces a short tangent segment, forming a small right triangle
%   with legs delta-x and delta-y, shown enlarged alongside
% width: 520
\ifnum\pdfoutput>0
