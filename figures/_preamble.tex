...
% it on next rebuild. See src/assets/diagrams/README.md for the full workflow.
%
...
% No \bs shorthand here on purpose. Figure labels are written in standard LaTeX
% so they read the same as post math and survive being pasted anywhere — see
% astro.config.mjs for why the matching KaTeX macro was retired.
